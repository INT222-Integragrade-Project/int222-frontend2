...
export default {
  ...
  methods: {
    ...
    async create() {
      ...
      this.color = await this.getcolor(); //loop for link productcolor and color
      let a = 0;
      for (let b = 0; b < this.color.length; b++) {
        if (this.color[b].colorId != this.id) {
          continue;
        } else if (this.color[b].colorId == this.id) {
          this.currentcolor[a] = this.color[b];
        }
        a++;
        console.log(a); // just check
      }
...
/* width */
.image-item-vertical::-webkit-scrollbar {
  width: 5px;
}
/* Track */
.image-item-vertical::-webkit-scrollbar-track {
  background: #f1f1f1;
  border-radius: 100px;
}
/* Handle */
.image-item-vertical::-webkit-scrollbar-thumb {
  background: #888;
  border-radius: 100px;
}
/* Handle on hover */
.image-item-vertical::-webkit-scrollbar-thumb:hover {
  background: #555;
}
...
/* width */
.image-item-horizontal::-webkit-scrollbar {
  width: 5px;
}
/* Track */
.image-item-horizontal::-webkit-scrollbar-track {
  background: #f1f1f1;
  border-radius: 100px;
}
/* Handle */
.image-item-horizontal::-webkit-scrollbar-thumb {
  background: #888;
  border-radius: 100px;
}
/* Handle on hover */
.image-item-horizontal::-webkit-scrollbar-thumb:hover {
  background: #555;
}
